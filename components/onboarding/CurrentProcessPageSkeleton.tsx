    ...
    <div className="nx-page-card">
      ...
      <div className="grid gap-y-8">
        {Array.from({ length: 4 }).map((_, index) => (
          <div key={index}>
            <div className="mb-3 h-5 w-64 animate-pulse rounded-[10px] bg-[rgba(255,255,255,0.08)]" />
            <div className="mb-3 h-5 w-full max-w-[560px] animate-pulse rounded-[10px] bg-[rgba(255,255,255,0.08)]" />
            <div className="h-[140px] w-full animate-pulse rounded-2xl border border-[rgba(255,255,255,0.06)] bg-[rgba(255,255,255,0.04)]" />
          </div>
        ))}
      </div>
