export default function PaymentPageSkeleton() {
  return (
    <div className="nx-page-card">
      <div className="mb-6 h-10 w-40 animate-pulse rounded-full bg-[rgba(255,255,255,0.08)]" />
      ...
      <div className="mb-10 space-y-3">
        ...
        <div className="h-5 w-full max-w-[560px] animate-pulse rounded-[10px] bg-[rgba(255,255,255,0.08)]" />
      </div>

      <div className="mb-8 rounded-[24px] border border-[rgba(255,255,255,0.08)] bg-[rgba(255,255,255,0.03)] p-6 sm:p-8">
        <div className="mb-3 h-5 w-40 animate-pulse rounded-[10px] bg-[rgba(255,255,255,0.08)]" />
        <div className="mb-6 h-10 w-full max-w-[420px] animate-pulse rounded-[12px] bg-[rgba(255,255,255,0.08)]" />

        <div className="grid grid-cols-1 gap-5 md:grid-cols-2">
          <div className="rounded-2xl border border-[rgba(255,255,255,0.08)] bg-[rgba(255,255,255,0.04)] p-5">
            <div className="mb-2 h-4 w-28 animate-pulse rounded-[10px] bg-[rgba(255,255,255,0.08)]" />
            <div className="h-9 w-32 animate-pulse rounded-[10px] bg-[rgba(255,255,255,0.08)]" />
          </div>

          <div className="rounded-2xl border border-[rgba(255,255,255,0.08)] bg-[rgba(255,255,255,0.04)] p-5">
            <div className="mb-2 h-4 w-36 animate-pulse rounded-[10px] bg-[rgba(255,255,255,0.08)]" />
            <div className="h-9 w-32 animate-pulse rounded-[10px] bg-[rgba(255,255,255,0.08)]" />
          </div>
        </div>
      </div>
            ...
            >
              <div className="flex flex-col gap-3 sm:flex-row sm:items-start sm:justify-between">
                ...
                <div className="w-full max-w-[180px] space-y-2">
                  <div className="h-4 w-full animate-pulse rounded-[10px] bg-[rgba(255,255,255,0.08)]" />
                  <div className="h-4 w-5/6 animate-pulse rounded-[10px] bg-[rgba(255,255,255,0.08)]" />
                </div>
              </div>
            </div>
          ))}
      ...
      <div className="mb-8 grid grid-cols-1 gap-5 md:grid-cols-2">
        <div className="rounded-[24px] border border-[rgba(255,255,255,0.08)] bg-[rgba(255,255,255,0.03)] p-6 sm:p-8">
        ...
        <div className="rounded-[24px] border border-[rgba(255,255,255,0.08)] bg-[rgba(255,255,255,0.03)] p-6 sm:p-8">
          <div className="mb-2 h-4 w-52 animate-pulse rounded-[10px] bg-[rgba(255,255,255,0.08)]" />
          <div className="h-10 w-36 animate-pulse rounded-[10px] bg-[rgba(255,255,255,0.08)]" />
        </div>
      </div>
      ...
      <div className="mb-8 grid grid-cols-1 gap-5 md:grid-cols-2">
        <div className="rounded-[24px] border border-[rgba(255,255,255,0.08)] bg-[rgba(255,255,255,0.03)] p-6 sm:p-8">
          <div className="mb-2 h-4 w-36 animate-pulse rounded-[10px] bg-[rgba(255,255,255,0.08)]" />
          <div className="mb-3 h-12 w-40 animate-pulse rounded-[10px] bg-[rgba(255,255,255,0.08)]" />
          <div className="h-4 w-full animate-pulse rounded-[10px] bg-[rgba(255,255,255,0.08)]" />
        </div>
