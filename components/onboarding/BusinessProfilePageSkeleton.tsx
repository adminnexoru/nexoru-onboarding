  ...
  return (
    <div className="nx-page-card">
      ...
      <div className="mb-10 space-y-3">
        <div className="h-5 w-full max-w-[680px] animate-pulse rounded-[10px] bg-[rgba(255,255,255,0.08)]" />
        <div className="h-5 w-full max-w-[520px] animate-pulse rounded-[10px] bg-[rgba(255,255,255,0.08)]" />
      </div>
      ...
      <div className="grid grid-cols-1 gap-x-6 gap-y-7 sm:gap-y-8 md:grid-cols-2">
        {Array.from({ length: 8 }).map((_, index) => (
          <div key={index}>
            ...
            <div className="h-14 w-full animate-pulse rounded-2xl border border-[rgba(255,255,255,0.06)] bg-[rgba(255,255,255,0.04)]" />
          </div>
        ))}
      </div>
